...
| Sección B — Objetos | 🔴 Pendiente | Placeholders |
...
4. Sección B: falta casos de uso (diagrama + documentación por UC), diagrama de clases (SOLID/patrones) y objetos. Componentes y Despliegue ya están completos (ver §1).
